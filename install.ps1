<#
	.SYNOPSIS
		Installs the d365ce.integrations Module from github
		
	.DESCRIPTION
		This script installs the d365ce.integrations Module from github.
