Describe "Remove-D365CeODataEntity Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Remove-D365CeODataEntity).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter EntityName' {
			$parameter = (Get-Command Remove-D365CeODataEntity).Parameters['EntityName']
		...
		It 'Should have the expected parameter Key' {
			$parameter = (Get-Command Remove-D365CeODataEntity).Parameters['Key']
		...
		It 'Should have the expected parameter Tenant' {
			$parameter = (Get-Command Remove-D365CeODataEntity).Parameters['Tenant']
		...
		It 'Should have the expected parameter URL' {
			$parameter = (Get-Command Remove-D365CeODataEntity).Parameters['URL']
		...
		It 'Should have the expected parameter ClientId' {
			$parameter = (Get-Command Remove-D365CeODataEntity).Parameters['ClientId']
		...
		It 'Should have the expected parameter ClientSecret' {
			$parameter = (Get-Command Remove-D365CeODataEntity).Parameters['ClientSecret']
		...
		It 'Should have the expected parameter EnableException' {
			$parameter = (Get-Command Remove-D365CeODataEntity).Parameters['EnableException']
