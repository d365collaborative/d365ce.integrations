Describe "Remove-D365CeODataEntity Unit Tests" -Tag "Unit" {
	...
	Describe "Ensuring unchanged command signature" {
		...
		It 'Should have the expected parameter RefPath' {
			$parameter = (Get-Command Remove-D365CeODataEntity).Parameters['RefPath']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -EntityName -Key -RefPath -Tenant -URL -ClientId -ClientSecret -EnableException
		#>
	}
