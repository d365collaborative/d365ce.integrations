Describe "Import-D365CeODataEntityBatchMode Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Import-D365CeODataEntityBatchMode).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter EntityName' {
			$parameter = (Get-Command Import-D365CeODataEntityBatchMode).Parameters['EntityName']
		...
		It 'Should have the expected parameter Payload' {
			$parameter = (Get-Command Import-D365CeODataEntityBatchMode).Parameters['Payload']
		...
		It 'Should have the expected parameter Tenant' {
			$parameter = (Get-Command Import-D365CeODataEntityBatchMode).Parameters['Tenant']
		...
		It 'Should have the expected parameter URL' {
			$parameter = (Get-Command Import-D365CeODataEntityBatchMode).Parameters['URL']
		...
		It 'Should have the expected parameter ClientId' {
			$parameter = (Get-Command Import-D365CeODataEntityBatchMode).Parameters['ClientId']
		...
		It 'Should have the expected parameter ClientSecret' {
			$parameter = (Get-Command Import-D365CeODataEntityBatchMode).Parameters['ClientSecret']
		...
		It 'Should have the expected parameter RawOutput' {
			$parameter = (Get-Command Import-D365CeODataEntityBatchMode).Parameters['RawOutput']
		...
		It 'Should have the expected parameter EnableException' {
			$parameter = (Get-Command Import-D365CeODataEntityBatchMode).Parameters['EnableException']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -EntityName -Payload -Tenant -URL -ClientId -ClientSecret -RawOutput -EnableException
		#>
	}
