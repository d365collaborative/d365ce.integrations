Describe "Add-D365CeODataConfig Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Add-D365CeODataConfig).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Name' {
			$parameter = (Get-Command Add-D365CeODataConfig).Parameters['Name']
		...
		It 'Should have the expected parameter Tenant' {
			$parameter = (Get-Command Add-D365CeODataConfig).Parameters['Tenant']
		...
		It 'Should have the expected parameter Url' {
			$parameter = (Get-Command Add-D365CeODataConfig).Parameters['Url']
		...
		It 'Should have the expected parameter ClientId' {
			$parameter = (Get-Command Add-D365CeODataConfig).Parameters['ClientId']
		...
		It 'Should have the expected parameter ClientSecret' {
			$parameter = (Get-Command Add-D365CeODataConfig).Parameters['ClientSecret']
		...
		It 'Should have the expected parameter Temporary' {
			$parameter = (Get-Command Add-D365CeODataConfig).Parameters['Temporary']
		...
		It 'Should have the expected parameter Force' {
			$parameter = (Get-Command Add-D365CeODataConfig).Parameters['Force']
		...
		It 'Should have the expected parameter EnableException' {
			$parameter = (Get-Command Add-D365CeODataConfig).Parameters['EnableException']
