Describe "Import-D365CeODataEntity Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Import-D365CeODataEntity).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter EntityName' {
			$parameter = (Get-Command Import-D365CeODataEntity).Parameters['EntityName']
		...
		It 'Should have the expected parameter Payload' {
			$parameter = (Get-Command Import-D365CeODataEntity).Parameters['Payload']
		...
		It 'Should have the expected parameter PayloadCharset' {
			$parameter = (Get-Command Import-D365CeODataEntity).Parameters['PayloadCharset']
		...
		It 'Should have the expected parameter RefPath' {
			$parameter = (Get-Command Import-D365CeODataEntity).Parameters['RefPath']
			$parameter.Name | Should -Be 'RefPath'
			$parameter.ParameterType.ToString() | Should -Be System.String
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
		...
		It 'Should have the expected parameter Tenant' {
			$parameter = (Get-Command Import-D365CeODataEntity).Parameters['Tenant']
		...
		It 'Should have the expected parameter URL' {
			$parameter = (Get-Command Import-D365CeODataEntity).Parameters['URL']
		...
		It 'Should have the expected parameter ClientId' {
			$parameter = (Get-Command Import-D365CeODataEntity).Parameters['ClientId']
		...
		It 'Should have the expected parameter ClientSecret' {
			$parameter = (Get-Command Import-D365CeODataEntity).Parameters['ClientSecret']
		...
		It 'Should have the expected parameter EnableException' {
			$parameter = (Get-Command Import-D365CeODataEntity).Parameters['EnableException']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -EntityName -Payload -PayloadCharset -RefPath -Tenant -URL -ClientId -ClientSecret -EnableException
		#>
	}
