...
Remove-Module d365ce.integrations -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\d365ce.integrations.psd1"
Import-Module "$PSScriptRoot\..\d365ce.integrations.psm1" -Force
